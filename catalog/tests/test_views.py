...
class AuthorListViewTest(TestCase):
    ...
    def test_author_lists_page_one_pagination_is_five(self):
        response = self.client.get(reverse('authors'))
        self.assertEqual(response.status_code, 200)
    ...
    def test_author_lists_page_two_pagination_is_five(self):
    ...
    def test_author_lists_final_page_equals_three(self):
...
class AuthorCreateViewTest(TestCase):
    ...
    def test_redirects_to_detail_view_on_success(self):
        login = self.client.login(
            username='testuser2', password='2HJ1vRV0Z&3iD')
        response = self.client.post(reverse(
            'author-create'), {'first_name': 'Christian Name', 'last_name': 'Surname'})
        self.assertEqual(response.status_code, 302)
    ...
    def test_form_date_of_death_initially_set_to_expected_date(self):
        ...
        response_date = response.context['form'].initial['died']
